...
public class CJCodeGenerator {
    ...
    // 数据库连接配置
    private static final String JDBC_URL = "jdbc:mysql://172.20.1.117:3306/cjwiki?useUnicode=true&useSSL=false&characterEncoding=utf8";
    ...
    // 表名，多个表使用英文逗号分割
    private static final String[] TBL_NAMES = { "ebook" };
